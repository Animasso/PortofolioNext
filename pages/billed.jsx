    ...
    <>
      ...
      <div className=" w-full">
        <ProjectDetail
          ...
          projetTitle="Billed"
          projetStructure="Le but de ce projet était de fiabiliser et améliorer le parcours employé de ce site web avec l'aide d'un rapport avec les bugs identifiés (Kanban Notion) .
          Mise en place de test avec JEST ainsi que la rédaction d'un de plan de tests End-to-End du site . "
